...
export default function AppliedResearchGrantsPage() {
  const t = useTranslations("ARGPage");
      ...
      <main className="min-h-screen bg-white font-poppins">
        ...
        >
          ...
          >
            ...
            <div
              className={`overflow-hidden ${isArabic ? "pb-4 sm:pb-5" : "pb-0.5"}`}
            >
              <motion.h1
        ...
        <RailSection tint title={t("portalTitle")}>
          <div className="space-y-4 font-poppins text-[15px] leading-[1.9] text-[#1D2D44]/65 font-light">
            ...
            <motion.p {...fadeUp(0.1)}>{t("portalLinkPlaceholder")}</motion.p>
        ...
        <RailSection tint title={t("contactTitle")}>
          <div className="space-y-3 font-poppins text-[15px] text-[#1D2D44]/65 font-light">
            ...
            <motion.p {...fadeUp(0.1)}>{t("contactBody2")}</motion.p>
