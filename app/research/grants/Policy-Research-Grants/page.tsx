...
const CALL_PDF_HREF =
  "https://kfas.sharepoint.com/Shared%20Documents/Forms/AllItems.aspx?id=%2FShared%20Documents%2FPublic%2FKFAS%2F2025%2F1st%20CALL%20FOR%20PROPOSAL%202026%20%2D%20Final%2Epdf&parent=%2FShared%20Documents%2FPublic%2FKFAS%2F2025&p=true&ga=1";
...
const LETTER_OF_INTENT_SAMPLE_HREF =
  "https://kfas.sharepoint.com/Shared%20Documents/Forms/AllItems.aspx?id=%2FShared%20Documents%2FPublic%2FKFAS%2FSample%20Letter%20of%20Intent%2Epdf&parent=%2FShared%20Documents%2FPublic%2FKFAS&p=true&ga=1";

export default function PolicyResearchGrantsPage() {
      ...
      <main className="min-h-screen bg-white font-poppins">
        ...
        >
          <motion.div className="absolute inset-0" style={{ y: heroY }}>
            <Image
              src="/image/PolicyBanner.png"
              alt="Professionals collaborating in a policy and research workshop setting"
              fill
              priority
              sizes="100vw"
          ...
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="mt-7 space-y-4 font-poppins text-[15px] leading-[1.9] text-[#1D2D44]/65 font-light">
              <motion.p {...fadeUp(0.05)}>
                ...
                provides grants for Policy Research Grant Proposals. Policy
                Research Grants can include program evaluation, cost-benefit,
                and cost analysis, needs assessment, single-subject or case
                studies, surveys, secondary data analysis, implementation
                studies, and outcome studies. It is expected that these research
                studies include potential policy recommendations and/or policy
                drafts for stakeholder consideration and implementation.
              </motion.p>
              <motion.p {...fadeUp(0.1)}>
        ...
        <RailSection title="Application Related Documents:">
          ...
          <div className="mt-8 space-y-4 font-poppins text-[15px] leading-[1.9] text-[#1D2D44]/65 font-light">
            ...
            <motion.p {...fadeUp(0.25)}>
              ...
              proposal to KFAS. (
              <a
                href={LETTER_OF_INTENT_SAMPLE_HREF}
                target="_blank"
                rel="noopener noreferrer"
