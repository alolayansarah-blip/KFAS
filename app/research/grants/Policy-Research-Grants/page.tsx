            ...
            <motion.div className="w-full" {...fadeUp(0)}>
              ...
              <div className="mt-7 space-y-4 font-poppins text-[15px] font-light leading-[1.9] text-[#1D2D44]/65">
                <p>
                  ...
                  studies, and outcome studies. It is expected that these
                  research studies include potential policy recommendations
                  and/or policy drafts for stakeholder consideration and
                  implementation.
                </p>
                <p>
