        ...
        <section className="bg-white py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="space-y-6">
              <p className="text-base text-justify font-light capitalize leading-[1.9] text-[#1D2D44]/65">
                ...
                and internationally by enabling collaborations with institutions
              ...
              <p className="text-base text-justify font-light capitalize leading-[1.9] text-[#1D2D44]/65">
                ...
                organizational agility and proficiency. We will strive
                constantly to be more effective and efficient, and we will
                strive to adhere to international standards. Through the
