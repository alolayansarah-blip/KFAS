...
const NAVIGATION_LINKS = [
  ...
  { label: "Our History", href: "/OurHistory" },
  { label: "Board of Directors", href: "/BoardOfDirectors" },
  // ⬇️ NEW — update href when the Media Library page is ready
...
const CONTACT_INFO = {
  ...
  city: "Kuwait City, Kuwait",
  mapUrl: "https://maps.app.goo.gl/ahSd2JURuochJzC17",
  // Keyless embed (no Maps API key needed). Resolves to KFAS by name.
  mapEmbedUrl:
    "https://www.google.com/maps?q=Kuwait%20Foundation%20for%20the%20Advancement%20of%20Sciences%2C%20Ahmad%20Al%20Jaber%20Street%2C%20Sharq%2C%20Kuwait&z=16&output=embed",
} as const;

// ⬇️ NEW — update href when the website policy page is ready
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 pt-16 lg:pt-20 pb-8">
        ...
        >
          ...
          >
            ...
            <div className="mb-5 h-px w-8 bg-white/30" />
            <p className="mb-6 text-[14px] font-light text-white/65 leading-relaxed">
              Sign up for our newsletter to stay updated on all the latest news
              and announcements.
            </p>
