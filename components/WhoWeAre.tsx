...
function WhoWeAre() {
  ...
  // Fires when ~25% of section is visible — user has scrolled into view
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="relative h-[500px] sm:h-[550px] lg:h-[600px]">
              ...
              {/* Ambient glow blobs */}
              <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-[#7DC0F1]/20 rounded-full blur-3xl pointer-events-none" />
              <div className="absolute -top-8 -right-8 w-40 h-40 bg-[#EC601B]/20 rounded-full blur-3xl pointer-events-none" />
            </div>
          </motion.div>
          ...
          <div className="space-y-6">
            ...
            {/* ── Animated title: KFAS → full name ── */}
            <div className="relative overflow-hidden min-h-[120px]">
              {/* Step 1 — "KFAS" appears, holds, then fades out upward */}
              <motion.h2
                ...
                className="absolute top-0 left-0 text-5xl lg:text-6xl font-bold text-orange-600 leading-tight tracking-wide"
              >
                KFAS
              </motion.h2>

              {/* Step 2 — Full name fades in from below */}
              <motion.div
              ...
              >
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-900 leading-tight tracking-tight flex-1">
                  <SplitText
